<?php /*a:2:{s:61:"E:\MyServer\www\test\application\admin\view\infoimg\edit.html";i:1605098661;s:61:"E:\MyServer\www\test\application\admin\view\index_layout.html";i:1603845814;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-card">
  <div class="layui-card-header">修改列表</div>
    <div class="layui-card-body">
        <form class="layui-form" method="post" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="classid" lay-verify="required" lay-search="">
                      ...
                      <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['infotype'] != 2): ?> disabled=""<?php endif; if($edit['classid'] == $vo['id']): ?> selected="" <?php endif; ?>><?php echo htmlentities($vo['classname']); ?></option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" lay-verify="required" name="title" value="<?php echo htmlentities($edit['title']); ?>" placeholder="文章标题">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" name="widths" id="widths" value="<?php echo htmlentities($edit['widths']); ?>" placeholder="宽度">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" name="heights" id="heights" value="<?php echo htmlentities($edit['heights']); ?>" placeholder="高度">
                </div>
                <div class="layui-form-mid layui-word-aux">px</div>
            </div>
            <div class="layui-form-item">

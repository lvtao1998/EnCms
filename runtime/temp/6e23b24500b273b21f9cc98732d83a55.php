<?php /*a:2:{s:60:"E:\MyServer\www\test\application\admin\view\index\index.html";i:1602728615;s:55:"E:\MyServer\www\test\application\admin\view\layout.html";i:1603845824;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item"><a href="<?php echo htmlentities(ROOT_URL); ?>" target="_blank"><i class="iconfont icon-homepage"></i><span class="winner-hide">&nbsp;站点主页</span></a></li>
        ...
        <div class="layui-footer">
            © ENCMS v<?php echo htmlentities(app('config')->get('version.yzncms_version')); ?>
        </div>
    </div>
